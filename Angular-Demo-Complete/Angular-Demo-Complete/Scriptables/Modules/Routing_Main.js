(function () {
    ...
    app.config(function ($routeProvider) {
        ...
        $routeProvider
            .when('/', {
                templateUrl: 'Pages/home.html?Version=1.7', //Why a query string? This way we can force browser to download new 'versions' as we make big changes
                controller: 'home_controller'
            })
            .when('/album/:id/', {
                templateUrl: 'Pages/AlbumSearch.html?Version=1.7',

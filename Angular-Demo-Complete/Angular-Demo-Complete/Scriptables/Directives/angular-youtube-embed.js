/* global YT */ /*Link: https://github.com/brandly/angular-youtube-embed */
    ...
    .directive('youtubeVideo', ['$window', 'youtubeEmbedUtils', function ($window, youtubeEmbedUtils) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                // Attach to element
                scope.playerHeight = document.getElementsByClassName('song-item')[0].offsetWidth * .58; //scope.playerHeight || 390;
                scope.playerWidth = document.getElementsByClassName('song-item')[0].offsetWidth; //scope.playerWidth || 640;
                scope.playerVars = scope.playerVars || {};

                angular.element($window).bind('resize', function () {
                    scope.playerWidth = document.getElementsByClassName('song-item')[0].offsetWidth;
                    scope.playerHeight = document.getElementsByClassName('song-item')[0].offsetWidth * .58;
                    var frame = document.getElementById(scope.playerId);
                    if (frame != null) {
                        frame.width = scope.playerWidth;
                        frame.height = scope.playerHeight;
                    }
